...
public class ProductController {
	...
	public String deleteProducts(HttpSession session,ModelMap map,@RequestParam int id) {
		return service.deleteProduct(id,map, session);
	}
	@GetMapping("/editRecord")
	public String editProducts(HttpSession session,ModelMap map,@RequestParam int id) {
